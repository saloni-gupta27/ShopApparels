    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <button className="bg-black text-white px-8 py-3 text-sm active:bg-gray-700" onClick={()=>{if(!clicked) {addToCart(productData._id,size);} else{ navigate('/cart')} setClicked(!clicked)}}>{`${clicked ? 'GO TO CART' : 'ADD TO CART'}`}</button>
